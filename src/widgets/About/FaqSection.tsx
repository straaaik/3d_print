...
export function FaqSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'Да! В 3D Labs реализована двухуровневая архитектура с автономным кэшированием. Вы можете продолжать рассчитывать заказы, редактировать каталог и учитывать катушки даже без сети. При появлении интернета данные бесшовно синхронизируются с облачной базой данных.'
    },
    {
