...
export function FaqSection() {
  ...
  const faqs = [
    {
      q: 'Как рассчитывается себестоимость в калькуляторе Kumo CRM?',
    ...
    },
    {
      ...
      a: 'Да! В Kumo CRM реализована двухуровневая архитектура с автономным кэшированием. Вы можете продолжать рассчитывать заказы, редактировать каталог и учитывать катушки даже без сети. При появлении интернета данные бесшовно синхронизируются с облачной базой данных.'
    },
    {
    ...
    },
    {
      ...
      a: 'Доступ осуществляется через защищенную систему аутентификации с закрытой регистрацией по лицензионным ключам доступа (Access Keys). Администратор мастерской может генерировать ключи для сотрудников и партнеров, управляя правами доступа.'
    }
  ];
