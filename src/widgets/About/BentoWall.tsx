  ...
  const cards = [
    {
      icon: Database,
      tag: 'ARCHITECTURE',
      title: 'Двойная защита данных (Cloud + Local)',
      desc: 'Автономная работа: данные мгновенно сохраняются локально и при наличии сети синхронизируются с защищенной облачной базой данных.',
