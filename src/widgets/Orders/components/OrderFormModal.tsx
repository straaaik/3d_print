...
function PhysicsQuantitySlider({
  value,
  onChange,
  min = 1,
  max = 100,
...
function NativeVerticalStatusList({
  value,
  onChange,
}: {
  value: OrderStatus;
...
function NativeVerticalChannelList({
  value,
  onChange,
}: {
  value: string;
...
function NativeEmbeddedCalendar({
  value,
  onChange,
...
function NativeDualDateCalendar({
  startDate,
  endDate,
  onChangeStartDate,
  onChangeEndDate,
