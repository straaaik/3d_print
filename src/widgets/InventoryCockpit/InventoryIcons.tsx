...
export function FilamentSpoolIcon({ title = 'Катушка филамента', filamentColor, ...props }: InventoryIconProps) {
  ...
  return (
    ...
    >
      ...
      {/* Верхняя намотка */}
      <ellipse cx="120" cy="68" rx="68" ry="20" fill={color} stroke="rgba(0,0,0,0.4)" strokeWidth="1" />
      {/* Верхний фланец */}
      ...
      <path d="M 188,75 C 198,82 204,95 200,108 C 196,118 190,124 184,126" stroke={color} strokeWidth="4" strokeLinecap="round" />
      <circle cx="184" cy="126" r="3" fill={color} />
    </svg>
  );
}
...
export function PrinterMachineIcon({ title = '3D-принтер', accentColor, ...props }: InventoryIconProps) {
  ...
  return (
    ...
    >
      ...
      <circle cx="120" cy="80" r="2.5" fill={color} />
      ...
      <path d="M110 114 L120 108 L130 114 L130 126 L120 132 L110 126 Z" fill={color} stroke="#09090b" strokeWidth="1.5" />
      ...
      <polygon points="52,50 120,32 188,50 188,148 120,166 52,148" fill="rgba(12,180,224,0.06)" stroke="rgba(255,255,255,0.2)" strokeWidth="1.5" />
      ...
      <rect x="138" y="27" width="26" height="7" rx="1" fill={color} fillOpacity="0.8" />
    </svg>
  );
}
