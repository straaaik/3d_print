      ...
      <div className="flex flex-col gap-1.5 w-full">
        ...
        <div className="relative flex items-center w-full">
          <input
            id={inputId}
            ref={ref}
            className={`w-full h-10 sm:h-11 bg-neutral-900 border border-white/15 hover:border-white/30 ${focusBorders} focus:outline-none rounded-xl px-3.5 text-white text-xs sm:text-sm font-mono font-medium transition-all duration-200 placeholder-neutral-600 shadow-inner ${
              unit ? 'pr-9' : ''
